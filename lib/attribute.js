...
validators.properties = function validateProperties (instance, schema, options, ctx) {
  ...
  for (var property in properties) {
    ...
    var postRes;
    if (typeof options.postValidateProperty == 'function') {
      postRes = options.postValidateProperty(instance, property, properties[property], options, ctx);
      result.importErrors(postRes);
    }
...
function testAdditionalProperty (instance, schema, options, ctx, property, result) {
  ...
  if (schema.additionalProperties === false) {
    ...
    var postRes;
    if (typeof options.postValidateProperty == 'function') {
      postRes = options.postValidateProperty(instance, property, additionalProperties, options, ctx);
      result.importErrors(postRes);
    }
...
validators.patternProperties = function validatePatternProperties (instance, schema, options, ctx) {
  ...
  for (var property in instance) {
    ...
    for (var pattern in patternProperties) {
      ...
      var postRes;
      if (typeof options.postValidateProperty == 'function') {
        postRes = options.postValidateProperty(instance, property, patternProperties[pattern], options, ctx);
        result.importErrors(postRes);
      }
...
validators.minLength = function validateMinLength (instance, schema, options, ctx) {
  ...
  var result = new ValidatorResult(instance, schema, options, ctx);
  if (!(helpers.getStringLength(instance) >= schema.minLength)) {
    result.addError({
      name: 'minLength',
...
validators.maxLength = function validateMaxLength (instance, schema, options, ctx) {
  ...
  var result = new ValidatorResult(instance, schema, options, ctx);
  if (!(helpers.getStringLength(instance) <= schema.maxLength)) {
    result.addError({
      name: 'maxLength',
